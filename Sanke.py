...
def get_or_create_user(username):
    ...
    cur.execute("""
        ...
        SELECT %s
        WHERE NOT EXISTS (
            SELECT 1 FROM snake_users WHERE username = %s
        )
    """, (username, username))
    conn.commit()
...
LEVELS = {
    1: {'speed': 7, 'walls': [[150, 150, 300, 20]]},
    2: {'speed': 10, 'walls': [[100, 100, 400, 20], [200, 300, 20, 200]]},
    3: {'speed': 13, 'walls': [[50, 200, 500, 20], [300, 50, 20, 500], [100, 400, 400, 20]]}
}
